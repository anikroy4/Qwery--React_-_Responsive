    ...
    <>
        <section className='bg-black'>
            <Container className="bg-[url(./Bromo.jpg)] bg-cover bg-no-repeat ">
                <div className='w-full pt-[559px] px-[194px]  pb-[32.92px] text-center font-Sans'>
                    <h4 className=' mx-auto text-[#FBD784] font-bold text-lg uppercase tracking-wide'>
                    Bromo
                    </h4>
                    <h2 className='w-[932px] pb-[14px]  text-white font-bold text-[64px] uppercase'>
                    Steady your steps, we will climb together!
                    </h2>
                    <p className='w-[893px] pl-[19.5px] pb-[26px] uppercase font-normal text-[15px] text-white  leading-8'>
